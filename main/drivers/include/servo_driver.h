...
#define SERVO_DRIVER_ORIENTATION_MIN_PWM	215	// ~1ms pulse
#define SERVO_DRIVER_ORIENTATION_MID_PWM	578	// 1.5ms pulse
#define SERVO_DRIVER_ORIENTATION_MAX_PWM	935	// ~2ms pulse
#define SERVO_DRIVER_ORIENTATION_10_PWM		40	// PWM Duty Cycle to move 10 degrees
