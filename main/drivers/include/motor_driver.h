...
#define MOTOR_DRIVER_PWM1_CHANNEL	LEDC_CHANNEL_1

#define MOTOR_DRIVER_GPIO_IN3		18
#define MOTOR_DRIVER_GPIO_IN4		19
#define MOTOR_DRIVER_GPIO_PWM2		05
#define MOTOR_DRIVER_PWM2_CHANNEL	LEDC_CHANNEL_2
...
#define MOTOR_RIGHT_F_GPIO		MOTOR_DRIVER_GPIO_IN1	// Forward
#define MOTOR_RIGHT_R_GPIO		MOTOR_DRIVER_GPIO_IN2	// Reverse
#define MOTOR_RIGHT_PWM_GPIO	MOTOR_DRIVER_GPIO_PWM1
#define MOTOR_RIGHT_PWM_CHANNEL	MOTOR_DRIVER_PWM1_CHANNEL
#define MOTOR_RIGHT_GPIO_PIN_SELECT	((1<<MOTOR_RIGHT_F_GPIO) | (1<<MOTOR_RIGHT_R_GPIO))

#define MOTOR_LEFT_F_GPIO		MOTOR_DRIVER_GPIO_IN3	// Forward
#define MOTOR_LEFT_R_GPIO		MOTOR_DRIVER_GPIO_IN4	// Reverse
#define MOTOR_LEFT_PWM_GPIO		MOTOR_DRIVER_GPIO_PWM2
#define MOTOR_LEFT_PWM_CHANNEL	MOTOR_DRIVER_PWM2_CHANNEL
